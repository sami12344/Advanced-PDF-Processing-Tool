...
def main():
    ...
    if choice == '1':
        # Full workflow: Enhance → Merge → Add Page Numbers
        ...
        for enhanced_pdf in tqdm(enhanced_pdfs, desc="Converting PDFs"):
            ...
            all_slides.extend(convert_from_path(pdf_path, dpi=300, fmt='jpeg'))
        ...
        # Enhance PDFs only (existing functionality)
        input_folder = input("Enter path to folder containing PDFs: ").strip()
        ...
        # Convert images to PDF with page numbers
        ...
        # Create a temporary PDF without page numbers
